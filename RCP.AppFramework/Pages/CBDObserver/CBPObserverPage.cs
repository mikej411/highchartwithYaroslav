...
{
    public class CBPObserverPage : Page, IDisposable
    {
        #region constructors
        public CBPObserverPage(IWebDriver driver) : base(driver)
        {
        }
        ...
        {
            this.WaitUntil(TimeSpan.FromSeconds(30), Criteria.CBPObserverPage.PageReady);
        }
